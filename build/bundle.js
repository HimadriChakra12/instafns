...
var { interceptStoryQuickReactions, interceptStoryReplies, interceptLikes, interceptComments, interceptCalls, interceptFollows, interceptReposts, forceHoverOnElement, keepElementClicked, releaseElementClick } = require("features/action-interceptors/index.js");
...
defineModule("features/action-interceptors/index.js", function (module, exports, require) {
var { confirmWithModal } = require("features/follow-analyzer/index.js");
var { stopEvent, dispatchFullClick, dispatchMouseClick, interceptClicks, interceptKeydown } = require("utils/eventInterceptor.js");
...
function interceptStoryQuickReactions() {
  intercept({
...
function interceptStoryReplies() {
  intercept({
    matcher: (e) =>
...
function forceHoverOnElement(selectorOrElement) {
...
function keepElementClicked(selectorOrElement, duration = null) {
  const el = getEl(selectorOrElement);
  if (!el) return console.error("[Instafn] Element not found"), false;
...
function releaseElementClick(selectorOrElement) {
  const el = getEl(selectorOrElement);
  if (!el) return console.error("[Instafn] Element not found"), false;
...
module.exports.interceptLikes = interceptLikes;
module.exports.interceptComments = interceptComments;
module.exports.interceptCalls = interceptCalls;
module.exports.interceptFollows = interceptFollows;
module.exports.interceptStoryQuickReactions = interceptStoryQuickReactions;
module.exports.interceptStoryReplies = interceptStoryReplies;
module.exports.interceptReposts = interceptReposts;
module.exports.forceHoverOnElement = forceHoverOnElement;
module.exports.keepElementClicked = keepElementClicked;
module.exports.releaseElementClick = releaseElementClick;
});
